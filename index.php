...
<body>
    ...
    <nav class="navbar main-navbar navbar-expand-lg navbar-light bg-light navbar-gradiente">
        <!-- con "fixed-top" se queda estaticamente arriba-->
        <div class="container">
            <nav class="">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <div class="navbar-nav main-navbar-nav">
                    <a class="nav-item nav-link main-nav-link" href="#">PROYECTOS     <span class="sr-only">(current)</span>    </a>
                    <a class="nav-item nav-link main-nav-link" href="#">DEDEV</a>
                    <a class="nav-item nav-link main-nav-link" href="#">NOTICIAS</a>
                    <a class="nav-item nav-link main-nav-link" href="#">AULAS VIRTUALES</a>
                    <a class="nav-item nav-link main-nav-link" href="#">RECURSOS MULTIMEDIA</a>
    ...
    <!-- Fin Menú - navbar de bootstrap-->

    <!-- Inicio del header-->
    <header class="main-header-gradiente main-header">
        <!-- Imagen de cambio  -->
        <div class="container">
            <div class="row">
                <div class="col-md-2">
                ...
                <div class="col-md-5 text-left justify-content-center align-self-center">
                    <H1><strong></strong><span class="color-text-1">INNOVANDO EN <br> LA </span><span class="color-text-2">EDUCACION SUPERIOR</span></H1>
                </div>
                <div class="col-md-4">
    ...
    <section>
        <div class="container features">
            ...
            <div class="row">
                <div class="col-md-1" style="height: 0px;">&nbsp;</div>
                <div class="col-md-2">
                ...
                <div class="col-md-3">
                    <div class="face-box  text-center justify-content-center align-self-center">
                        ...
                        <div style="display: inline-block;">
                            <h2>Live Facebook</h2>
                            <p>En vivo en este momento</p>
                        </div>
                    </div>
                    <br>
                    <div class="face-cont  text-center justify-content-center align-self-center">
                        <div>
                            <h2>¿Que hay de nuevo?</h2>
                        </div>
                        <div class="box-gray">&nbsp; </div><br>
                        <div class="box-gray">&nbsp;</div><br>
                        <div class="box-gray">&nbsp;</div><br>
                    </div>
                </div>
            ...
            <!--
            <div class="col-md-1 bar-side ">
                <div class="bar-side-img ">
                    &nbsp;
                </div>
            </div> -->
        </div>
    ...
    <section class="about">
        <div class="container">
            ...
            <div class="imageleft " style="top: 20%;">&nbsp;</div>
            <div class="imageleft " style="top: 35%;">&nbsp;</div>
            <div class="imageleft " style="top: 50%;">&nbsp;</div>
            <div class="imageleft " style="top: 65%;">&nbsp;</div>
            <div class="imageleft " style="top: 80%;">&nbsp;</div>
            <div class="imageright " style="top: 20%;">&nbsp;</div>
            <div class="imageright " style="top: 35%;">&nbsp;</div>
            <div class="imageright " style="top: 50%;">&nbsp;</div>
            <div class="imageright " style="top: 65%;">&nbsp;</div>
            <div class="imageright " style="top: 80%;">&nbsp;</div>
        </div>
    </section>
    <!-- END ABOUT -->
